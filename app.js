...
const distributorsData = [
    {name: 'ADHITHYA EDIFICE CONCEPTZ(NEW)', city: 'Bangalore', retailers: 195, lat: 12.9386, lng: 77.5441, target: 0, sales: 0, tsm: 'Sunil Kumar DN', asm: 'Suresh Be', bdm: 'Shivakumar HC', classification: 'Distributor', state: 'Karnataka', active: 'Active'},
    {name: 'ADHITHYA ESSENTIALS', city: 'Bangalore', retailers: 155, lat: 12.9616, lng: 77.5385, target: 0, sales: 0, tsm: 'Vacant', asm: 'Suresh Be', bdm: 'Shivakumar HC', classification: 'Distributor', state: 'Karnataka', active: 'Active'},
    {name: 'B P AGENCY', city: 'Bengaluru', retailers: 55, lat: 12.9702, lng: 77.5619, target: 0, sales: 0, tsm: 'Vacant', asm: 'Suresh Be', bdm: 'Shivakumar HC', classification: 'Distributor', state: 'Karnataka', active: 'Active'},
    {name: 'BHARATH CARE (BANGALORE)', city: 'Bengaluru', retailers: 19, lat: 13.0116, lng: 77.7263, target: 0, sales: 0, tsm: 'Rajshekhar J', asm: 'Suresh Be', bdm: 'Vacant', classification: 'Distributor', state: 'Karnataka', active: 'Active'},
    {name: 'BHASKAR-GOWRIBIDNUR', city: 'Tumkur', retailers: 38, lat: 13.522, lng: 77.2373, target: 0, sales: 0, tsm: 'G R Harish', asm: 'Suresh Be', bdm: 'Srikanth BN', classification: 'Distributor', state: 'Karnataka', active: 'Active'},
    {name: 'DINESH KUMAR (BENGALURU)', city: 'Bengaluru', retailers: 21, lat: 12.7981, lng: 77.6846, target: 0, sales: 0, tsm: 'Vacant', asm: 'Suresh Be', bdm: 'Shivakumar HC', classification: 'Distributor', state: 'Karnataka', active: 'Active'},
    {name: 'ETERNAL TRADERS', city: 'Bangalore', retailers: 149, lat: 13.0214, lng: 77.6585, target: 0, sales: 0, tsm: 'K Mahendra Maiya', asm: 'Tejas Manjunath', bdm: 'Vacant', classification: 'Distributor', state: 'Karnataka', active: 'Active'},
    {name: 'G S Enterprises(Bengaluru) NEW', city: 'Bengaluru', retailers: 216, lat: 13.1391, lng: 77.4876, target: 0, sales: 0, tsm: 'Yatheesh N', asm: 'Suresh Be', bdm: 'Srikanth BN', classification: 'Distributor', state: 'Karnataka', active: 'Active'},
    {name: 'GARUDA ENTERPRISES', city: 'Bangalore', retailers: 156, lat: 12.926, lng: 77.5293, target: 0, sales: 0, tsm: 'Vinod Kumar KJ', asm: 'Suresh Be', bdm: 'Shivakumar HC', classification: 'Distributor', state: 'Karnataka', active: 'Active'},
    {name: 'HANVIK CREATIONS', city: 'Bangalore', retailers: 38, lat: 12.9917, lng: 77.5073, target: 0, sales: 0, tsm: 'Vacant', asm: 'Suresh Be', bdm: 'Shivakumar HC', classification: 'Distributor', state: 'Karnataka', active: 'Active'},
    {name: 'K B C DISTRIBUTORS', city: 'Bengaluru', retailers: 269, lat: 12.8452, lng: 77.6604, target: 0, sales: 0, tsm: 'Vacant', asm: 'Suresh Be', bdm: 'Shivakumar HC', classification: 'Distributor', state: 'Karnataka', active: 'Active'},
    {name: 'P G C (BANGLORE)', city: 'Bengaluru', retailers: 59, lat: 12.9732, lng: 77.5286, target: 0, sales: 0, tsm: 'Vinod Kumar KJ', asm: 'Suresh Be', bdm: 'Shivakumar HC', classification: 'Distributor', state: 'Karnataka', active: 'Active'},
    {name: 'S L V enterprises (Bengaluru)', city: 'Bengaluru', retailers: 22, lat: 12.9181, lng: 77.5442, target: 0, sales: 0, tsm: 'Praveen Kumar S N', asm: 'Suresh Be', bdm: 'Shivakumar HC', classification: 'Distributor', state: 'Karnataka', active: 'Active'},
    {name: 'S S AGENCIES (BANGALORE)', city: 'Varthur', retailers: 188, lat: 13.0056, lng: 77.4982, target: 0, sales: 0, tsm: 'Babu Reddy C S', asm: 'Suresh Be', bdm: 'Vacant', classification: 'Distributor', state: 'Karnataka', active: 'Active'},
    {name: 'SLN Enterprises', city: 'Chikkaballapur', retailers: 51, lat: 13.4356, lng: 77.7311, target: 0, sales: 0, tsm: 'G R Harish', asm: 'Suresh Be', bdm: 'Srikanth BN', classification: 'Distributor', state: 'Karnataka', active: 'Active'},
    {name: 'SBM Enterprises', city: 'Bengaluru', retailers: 190, lat: 12.8001, lng: 77.6092, target: 0, sales: 0, tsm: 'Vacant', asm: 'Suresh Be', bdm: 'Shivakumar HC', classification: 'Distributor', state: 'Karnataka', active: 'Active'},
    {name: 'Shashank Enterprises', city: 'Bengaluru', retailers: 134, lat: 12.8826, lng: 77.6412, target: 0, sales: 0, tsm: 'Vacant', asm: 'Suresh Be', bdm: 'Vacant', classification: 'Distributor', state: 'Karnataka', active: 'Active'},
    {name: 'SLN ENTERPRISES', city: 'Chikkaballapur', retailers: 37, lat: 13.4356, lng: 77.7311, target: 0, sales: 0, tsm: 'G R Harish', asm: 'Suresh Be', bdm: 'Srikanth BN', classification: 'Distributor', state: 'Karnataka', active: 'Active'},
    {name: 'SM ELIXIR', city: 'Bengaluru', retailers: 4, lat: 12.9352, lng: 77.5838, target: 0, sales: 0, tsm: 'Vacant', asm: 'Suresh Be', bdm: 'Shivakumar HC', classification: 'Distributor', state: 'Karnataka', active: 'Active'},
    {name: 'SM INFRA ELECTRADE', city: 'Bangalore', retailers: 6, lat: 12.9352, lng: 77.5838, target: 0, sales: 0, tsm: 'Vacant', asm: 'Suresh Be', bdm: 'Shivakumar HC', classification: 'Distributor', state: 'Karnataka', active: 'Active'},
    {name: 'SRI MANJUNATHA ENTERPRISES', city: 'Tumkur', retailers: 22, lat: 13.3409, lng: 77.101, target: 0, sales: 0, tsm: 'Nagaraj P', asm: 'Suresh Be', bdm: 'Vacant', classification: 'Distributor', state: 'Karnataka', active: 'Active'},
    {name: 'VIVAN WORLD WIDES', city: 'Bengaluru', retailers: 123, lat: 13.0285, lng: 77.5406, target: 0, sales: 0, tsm: 'Chandra Shekhar AN', asm: 'Suresh Be', bdm: 'Shivakumar HC', classification: 'Distributor', state: 'Karnataka', active: 'Active'},
    {name: 'PMG ENTERPRISES', city: 'Chikkaballapur', retailers: 18, lat: 13.3956, lng: 77.8702, target: 0, sales: 0, tsm: 'Vacant', asm: 'Suresh Be', bdm: 'Srikanth BN', classification: 'Distributor', state: 'Karnataka', active: 'Active'},
    {name: 'JAI MARUTHI ENTERPRISES (BANGLORE)', city: 'Bangalore', retailers: 47, lat: 13.0056, lng: 77.5562, target: 0, sales: 0, tsm: 'Vacant', asm: 'Suresh Be', bdm: 'Vacant', classification: 'Distributor', state: 'Karnataka', active: 'Active'}
];
// Plant locations
const plants = {
