...
async function loadPOIDataFromBlob(blob) {
    try {
        console.log('📦 Processing CSV file, size:', blob.size, 'bytes');
        document.getElementById('poiStatusText').textContent = 'Loading CSV file...';
        
        // Read CSV directly (no ZIP extraction)
        const csvText = await blob.text();
        console.log(`✅ CSV loaded: ${csvText.length.toLocaleString()} characters`);
        ...
        await parsePOIData(csvText, 'data.csv');
